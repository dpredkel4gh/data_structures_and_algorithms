...
public class BinarySearchTree {
    ...
    public List<Integer> breadthFirstSearchRecursive(List<Node> queue, List<Integer> resultArray) {
        if (queue.isEmpty()) {
            return resultArray;
        }
    ...
    public List<Integer> DFSInOrder() {
        ...
        return TreeHelperDFS.traverseInOrder(this.root, answer);
    }

    public List<Integer> DFSPreOrder() {
        List<Integer> answer = new ArrayList<>();
        return TreeHelperDFS.traversePreOrder(this.root, answer);
    }

    public List<Integer> DFSPostOrder() {
        List<Integer> answer = new ArrayList<>();
        return TreeHelperDFS.traversePostOrder(this.root, answer);
    }
